...
interface PositionDatatableFiltersProps {
 ...
 *
 * @returns The composed position filters.
 *
 * @author Moisés Reis
 *
 * @date 2026-09-25
 */
function PositionDatatableFilters({
  portfolioId,
  fundId,
  dateRange,
  portfolioOptions,
  ...
  return (
    <>
      <EntitySelectFilter
        ...
        placeholder={
          POSITION_DATATABLE.FILTER_PORTFOLIO_PLACEHOLDER
        }
      ...
      <EntityDateRangeFilter
        ...
        placeholder={POSITION_DATATABLE.FILTER_DATE_PLACEHOLDER}
      />
    </>
  )
}

export { PositionDatatableFilters }
