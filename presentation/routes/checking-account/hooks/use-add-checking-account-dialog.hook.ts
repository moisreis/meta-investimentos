...
/**
 * @summary
 * Coordinates the add dialog flow of the checking
 * account route.
 *
 * @remarks
 ...
 * flow state out of the presentational layer. The
 * toolbar add-item button triggers `handleOpen`.
 *
 ...
 * @date 2026-09-25
 */
function useAddCheckingAccountDialog() {
...
export { useAddCheckingAccountDialog }
