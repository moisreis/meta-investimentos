...
// Option rendered by the bank account combobox.
export interface CheckingAccountRegistryComboboxItem {
...
interface BankAccountComboboxProps {
  ...
  placeholder: string
  items: CheckingAccountRegistryComboboxItem[]
  required?: boolean
  disabled?: boolean
...
function BankAccountCombobox({
  ...
  return (
    ...
    >
      ...
      <ComboboxContent>
        <ComboboxEmpty>
          {CHECKING_ACCOUNT_FORM.SEARCH_EMPTY}
        </ComboboxEmpty>
        <ComboboxList>
          {(item) => (
