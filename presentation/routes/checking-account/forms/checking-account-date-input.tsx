...
interface CheckingAccountDateInputProps {
  id: string
  name: string
  value: string
...
/**
 * @summary
 * Renders the date picker of the checking account forms.
 *
 * @remarks
 ...
 *
 * @explanation
 * Use for the date field of the checking account forms.
 * The string contract matches the previous native date
 * input, so the record payload stays unchanged.
 *
 * @author Moisés Reis
 *
 * @date 2026-09-25
 */
function CheckingAccountDateInput({
  id,
  name,
  value,
  onValueChange,
...
export { CheckingAccountDateInput }
