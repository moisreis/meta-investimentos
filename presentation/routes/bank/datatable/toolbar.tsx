...
import { BANK_DATATABLE_COLUMN_LABELS } from "@/presentation/routes/bank/settings/labels.settings"

interface BankDatatableToolbarProps<TData extends RowData> {
 ...
 *
 * @returns The bank datatable toolbar.
 *
 * @author Moisés Reis
 *
 * @date 2026-09-25
 */
function BankDatatableToolbar<TData extends RowData>({
  table,
  onAddItem,
  filters,
}: BankDatatableToolbarProps<TData>) {
  return (
        ...
        <>
          <EntityDatatableEditColumnsButton
            ...
            getColumnLabel={(column) =>
              BANK_DATATABLE_COLUMN_LABELS[column.id] ??
              column.id
            }
          />
