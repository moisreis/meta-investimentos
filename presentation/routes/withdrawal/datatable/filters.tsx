...
interface WithdrawalDatatableFiltersProps {
 ...
 *
 * @returns The composed withdrawal filters.
 *
 * @author Moisés Reis
 *
 * @date 2026-09-25
 */
function WithdrawalDatatableFilters({
  portfolioId,
  fundId,
  dateRange,
  portfolioOptions,
  ...
  onFundChange,
  onDateRangeChange,
}: WithdrawalDatatableFiltersProps) {
  return (
    <>
      <EntitySelectFilter
        value={portfolioId}
        ...
        placeholder={
          WITHDRAWAL_DATATABLE.FILTER_PORTFOLIO_PLACEHOLDER
        }
      ...
      <EntitySelectFilter
        ...
        options={fundOptions}
        placeholder={
          WITHDRAWAL_DATATABLE.FILTER_FUND_PLACEHOLDER
        }
      ...
      <EntityDateRangeFilter
        ...
        placeholder={
          WITHDRAWAL_DATATABLE.FILTER_DATE_PLACEHOLDER
        }
      />
    </>
  )
...
export { WithdrawalDatatableFilters }
