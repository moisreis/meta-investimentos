 ...
 *
 * @remarks
 * Tracks the category being edited, the dialog open
 ...
 * @date 2026-09-25
 */
function useCategoryEditDialog() {
  const ROUTER = useRouter()
  const [TARGET, setTarget] =
    React.useState<CategoryResponseDTO | null>(null)
