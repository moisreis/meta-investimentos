...
import { useSharedConfirmDeleteDialog } from "./hooks/use-shared-confirm-delete-dialog.hook"

export interface SharedConfirmDeleteDialogProps<TItem> {
 ...
 * @date 2026-09-22
 */
function SharedConfirmDeleteDialog<TItem>({
  open,
  onOpenChange,
  item,
  onDelete,
  itemLabel = "item",
}: SharedConfirmDeleteDialogProps<TItem>) {
  const {
    isSubmitting,
    hasRemoved,
    hasError,
...
export { SharedConfirmDeleteDialog }