 ...
 * for test fixtures.
 */
export const TRANSACTION_ALLOCATION_ID =
 ...
 */
export const SECOND_ALLOCATION_ID =
 ...
 */
export const TRANSACTION_ALLOCATION =
 ...
 */
export const OTHER_TRANSACTION_ALLOCATION =
  TransactionAllocationEntity.create(
    {
 ...
 */
export const SECOND_ALLOCATION =
  TransactionAllocationEntity.create(
    {
      applicationId: EntityId.create(ID.APPLICATION.DEFAULT),
      withdrawId: EntityId.create(ID.WITHDRAWAL.OTHER),
 ...
 */
export const CONSUMED_QUOTAS_SUM =
  QuotaQuantity.create("4.5");
 ...
 */
export async function seedAllocations(): Promise<
...
> {
  ...
  for (const fixture of [
    ...
    await db.insert(transactionAllocation).values({
      ...
      quotasConsumed:
        fixture.quotasConsumed.value.toString(),
 ...
 *          fixtures.
 */
export async function seedAllAllocations(): Promise<
  TransactionAllocation[]
> {
  await seedTransactionContext();
