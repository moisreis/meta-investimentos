...
export class Portfolio {
   ...
   * @throws {Error} If `props.annualInterestRate` is missing.
  ...
  public static create(props: PortfolioProps, id?: string): Portfolio {
    if (!props.acronym || props.acronym.trim() === "") {
      throw new Error("Portfolio must have an acronym.");
    }
    if (!props.name || props.name.trim() === "") {
      throw new Error("Portfolio must have a name.");
    }
    if (!props.userId || props.userId.trim() === "") {
      throw new Error("Portfolio must have a user id.");
    }
    if (!props.annualInterestRate) {
      throw new Error("Portfolio must have an annual interest rate.");
    }
    if (!props.minAllocation) {
      throw new Error("Portfolio must have a minimum allocation.");
    }
    if (!props.maxAllocation) {
      throw new Error("Portfolio must have a maximum allocation.");
    }
    if (!props.targetAllocation) {
      throw new Error("Portfolio must have a target allocation.");
    }
