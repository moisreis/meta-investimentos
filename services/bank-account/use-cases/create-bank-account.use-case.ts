 ...
 *
 * @example
 * const BANK_ACCOUNT = await CREATE_BANK_ACCOUNT_USE_CASE.execute({
...
export class CreateBankAccountUseCase {
   ...
   * @returns The persisted bank account response.
   *
   * @author Moisés Reis
   *
   * @date 2026-09-15
   */
  async execute(input: CreateBankAccountInput): Promise<BankAccountResponseDTO> {
